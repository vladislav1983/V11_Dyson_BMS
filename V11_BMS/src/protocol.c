...
// vacuum type message
//static const uint8_t msg_vac_type_v15[] = {0x1A, 0x00, 0x31, 0x01, 0xC0, 0xFF, 0x03, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0xFF, 0x21, 0xBF, 0xCB, 0xAC};
//static const uint8_t msg_vac_type_v11[] = {0x1A, 0x00, 0x31, 0x01, 0xC0, 0x01, 0x02, 0x00, 0x00, 0x20, 0x00, 0x00, 0x04, 0x00, 0x23, 0x00, 0x03, 0x03, 0x02, 0x00, 0x00, 0x00, 0x10, 0x00, 0xFF, 0x69, 0x4D, 0x83, 0x84};
//static const uint8_t msg_vac_type_res[] = {0x0B, 0x00, 0x49, 0x01, 0xC0, 0x02, 0x01, 0x00, 0x01, 0x00, 0xF0, 0xA2, 0xFF, 0x14};

// handshake between vacuum and bms, reguired to turn on unit
static const uint8_t msg_vac_v15_handshake_req[]   = {0x22, 0x00, 0xE4, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x13, 0x02, 0x10, 0x02, 0x81, 0x02, 0x10, 0x01, 0x02, 0x02, 0x10, 0x15, 0x81, 0x02, 0x10, 0x14, 0x81, 0x16, 0x82, 0x00, 0x00, 0x01, 0x00, 0x68, 0xCC, 0x78, 0x60};
static const uint8_t msg_bms_v15_handshake_res[]   = {0x30, 0x00, 0x2B, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x13, 0x01, 0x10, 0x02, 0x81, 0x02, 0x00, 0xB8, 0x02, 0x01, 0x10, 0x01, 0x02, 0x04, 0x00, 0xC0, 0x27, 0x09, 0x00, 0x01, 0x10, 0x15, 0x81, 0x02, 0x00, 0xD8, 0x72, 0x01, 0x10, 0x14, 0x81, 0x02, 0x00, 0x76, 0x48, 0x01, 0x00, 0x21, 0x32, 0x21, 0xD1};

static const uint8_t msg_vac_v11_handshake_req[]   = {0x20, 0x00, 0x3E, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x13, 0x02, 0x10, 0x00, 0x81, 0x02, 0x10, 0x02, 0x81, 0x02, 0x10, 0x01, 0x02, 0x02, 0x10, 0x15, 0x81, 0x02, 0x10, 0x14, 0x81, 0xE7, 0xF3, 0xD3, 0xC0};
static const uint8_t msg_bms_v11_handshake_res[]   = {0x35, 0x00, 0x33, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x13, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0x01, 0x10, 0x02, 0x81, 0x02, 0x00, 0x1F, 0x00, 0x01, 0x10, 0x01, 0x02, 0x04, 0x00, 0x20, 0xDB, 0xDE, 0x0A, 0x00, 0x01, 0x10, 0x15, 0x81, 0x02, 0x00, 0xD8, 0x72, 0x01, 0x10, 0x14, 0x81, 0x02, 0x00, 0x76, 0x48, 0x87, 0x91, 0xA0, 0x74};

// request/response between vacuum and bms (byte 9 is rolling counter)
static const uint8_t msg_vac_data_req[]    = {0x21, 0x00, 0x53, 0x01, 0xC0, 0x01, 0x02, 0x04, 0x02, 0x10, 0x00, 0x81, 0x02, 0x10, 0x01, 0x21, 0x02, 0x10, 0x0D, 0x25, 0x02, 0x10, 0x02, 0x22, 0x02, 0x10, 0x05, 0x81, 0x02, 0x10, 0x06, 0x81, 0x96, 0xDD, 0x33, 0x81};
// bms response of 0x21 is 0x38 (byte 9 is rolling counter, must be copied from 0x21)
static const uint8_t msg_bms_data_res[]   = {0x38, 0x00, 0xC1, 0x01, 0xC0, 0x02, 0x01, 0x04, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x01, 0x01, 0x10, 0x01, 0x21, 0x01, 0x00, 0x00, 0x01, 0x10, 0x0D, 0x25, 0x02, 0x00, 0xFA, 0x25, 0x01, 0x10, 0x02, 0x22, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x05, 0x81, 0x02, 0x00, 0x67, 0x11, 0x01, 0x10, 0x06, 0x81, 0x01, 0x00, 0x01, 0x7F, 0x52, 0x4C, 0xE7};

// vacuum trigger message request
static const uint8_t msg_vac_trig_req_ok[]  = {0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x11, 0x00, 0x82, 0x40, 0x42, 0x0F, 0x00, 0x02, 0x10, 0x00, 0x81, 0xC5, 0x6A, 0xE2, 0x0B};
//                               unstuffed     0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0xDB, 0xDE, 0x00, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x02, 0x10, 0x00, 0x81, 0xD7, 0xBA, 0xB5, 0x68
//static const uint8_t msg_vac_trig_req_nok[] = {, 0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x12, 0x00, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x02, 0x10, 0x00, 0x81, 0xD7, 0xBA, 0xB5, 0x68};
// bms response of msg 0x16 is 0x1B
// vac running
static const uint8_t msg_bms_trig_on_res_ok[]   = {0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x20, 0xDB, 0xDE, 0x0A, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x01, 0xA9, 0x82, 0xBE, 0x65};
// vac not running
static const uint8_t msg_bms_trig_off_res_ok[]  = {0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0x71, 0x76, 0x13, 0x64};
//static const uint8_t msg_bms_trig_off_res_nok[] = {0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0xDB, 0xDE, 0x01, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0xF5, 0x2D, 0x89, 0x37};

static const uint8_t msg_vac_trig_req_sleep[]  = {0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x11, 0x00, 0x82, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10, 0x00, 0x81, 0x48, 0x54, 0x1C, 0xBC};
static const uint8_t msg_bms_trig_res_sleep[]  = {0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0xC0, 0x30, 0xAD, 0x8F};
