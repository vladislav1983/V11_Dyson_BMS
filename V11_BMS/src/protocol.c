...
static const uint8_t msg_vac_trig_req_0x11[]       = {0x12, 0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x11, 0x00, 0x82, 0x40, 0x42, 0x0F, 0x00, 0x02, 0x10, 0x00, 0x81, 0xC5, 0x6A, 0xE2, 0x0B, 0x12};
...
static const uint8_t msg_vac_trig_req_0x12[]     = {0x12, 0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x12, 0x00, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x02, 0x10, 0x00, 0x81, 0xD7, 0xBA, 0xB5, 0x68, 0x12};
...
static const uint8_t msg_bms_trig_on_res_2[]  = {0x12, 0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0xDB, 0xDE, 0x01, 0x82, 0x20, 0xDB, 0xDE, 0x0A, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x01, 0x2D, 0xD9, 0x24, 0x36, 0x12};

// vac not running
static const uint8_t msg_bms_trig_off_res[]   = {0x12, 0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0x71, 0x76, 0x13, 0x64, 0x12};
static const uint8_t msg_bms_trig_off_res_2[] = {0x12, 0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0xDB, 0xDE, 0x01, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0xF5, 0x2D, 0x89, 0x37, 0x12};

// vac during and afrer charging
//static const uint8_t msg_bms_trig_chrg_res[]  = {0x12, 0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x98, 0x3A, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0x71, 0x76, 0x13, 0x64, 0x12};

// vacuum trigger message request on init
static const uint8_t msg_vac_trig_req_0x11_init[] = {0x12, 0x16, 0x00, 0xAE, 0x00, 0xC0, 0x01, 0x03, 0x01, 0x07, 0x10, 0x11, 0x00, 0x82, 0x00, 0x00, 0x00, 0x00, 0x02, 0x10, 0x00, 0x81, 0x48, 0x54, 0x1C, 0xBC, 0x12};
static const uint8_t msg_bms_trig_res_0x11_init[] = {0x12, 0x1B, 0x00, 0x5C, 0x01, 0xC0, 0x03, 0x01, 0x01, 0x08, 0x10, 0x11, 0x01, 0x82, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x10, 0x00, 0x81, 0x01, 0x00, 0x00, 0xC0, 0x30, 0xAD, 0x8F, 0x12};

static const prot_cfg_t prot_cfg[] = 
{
  {
    .msg_req_ptr      = msg_vac_trig_req_0x11_init,
    .msg_res_ptr      = msg_bms_trig_res_0x11_init,
    .msg_req_cmp_size = sizeof(msg_vac_trig_req_0x11_init),
  ...
  {
    .msg_req_ptr      = msg_vac_trig_req_0x11,
    .msg_res_ptr      = NULL,
    .msg_req_cmp_size = 11,
...
void prot_mainloop(void)
{
  ...
  switch(prot_state)
  {
    ...
    case PROT_TX_TRIGGER_RESP:
    {
      ...
      if(0 == memcmp(serial_buffer_rx, msg_vac_trig_req_0x11, 12))
      {
      ...
      else if(0 == memcmp(serial_buffer_rx, msg_vac_trig_req_0x12, 12))
      {
        if(charger_connected == false && prot_trigger_state != false)
          serial_send((uint8_t*)msg_bms_trig_on_res_2, sizeof(msg_bms_trig_on_res_2));
        else
          serial_send((uint8_t*)msg_bms_trig_off_res_2, sizeof(msg_bms_trig_off_res_2));
      }
